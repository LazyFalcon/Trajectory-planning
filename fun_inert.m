...
for i=1:s
    if (i==1) && (J1~=0)
        ...
        if R(i)==0
        Jx=m(i)*((sqrt(wsp(i,2)^2+wsp(i,3)^2)))^2;
        Jy=m(i)*((sqrt(wsp(i,1)^2+wsp(i,3)^2)))^2;
        Jz=m(i)*((sqrt(wsp(i,1)^2+wsp(i,2)^2)))^2;
        elseif R(i)==1
        Jx=1/3*m(i)*(2*(sqrt(wsp(i,2)^2+wsp(i,3)^2)))^2;
        Jy=1/3*m(i)*(2*(sqrt(wsp(i,1)^2+wsp(i,3)^2)))^2;
        Jz=1/3*m(i)*(2*(sqrt(wsp(i,1)^2+wsp(i,3)^2)))^2;
        end
