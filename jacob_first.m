...
for i=1:y-1;
    if zmie(i,1)==1                             
        J(1,i)=simple(-T{1,i}(1,1)*T{i,y}(2,4)+T{1,i}(1,2)*T{i,y}(1,4));
        J(2,i)=simple(-T{1,i}(2,1)*T{i,y}(2,4)+T{1,i}(2,2)*T{i,y}(1,4));
        J(3,i)=simple(-T{1,i}(3,1)*T{i,y}(2,4)+T{1,i}(3,2)*T{i,y}(1,4));
        J(4,i)=T{1,i}(1,3);
        J(5,i)=T{1,i}(2,3);
        J(6,i)=T{1,i}(3,3); 
    elseif zmie(i,2)==1                                
    ...
    elseif zmie(i,3)==1                            
        ...
        J(6,i)=0;
    elseif zmie(i,4)==1                             
        J(1,i)=simple(-T{1,i}(1,2)*T{i,y}(3,4)+T{1,i}(1,3)*T{i,y}(2,4));
        J(2,i)=simple(-T{1,i}(2,2)*T{i,y}(3,4)+T{1,i}(2,3)*T{i,y}(2,4));
        J(3,i)=simple(-T{1,i}(3,2)*T{i,y}(3,4)+T{1,i}(3,3)*T{i,y}(2,4));
        J(4,i)=T{1,i}(1,1);
        J(5,i)=T{1,i}(1,2);
        J(6,i)=T{1,i}(1,3);
    end
